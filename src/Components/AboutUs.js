            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                <div
                  ...
                  style={{
                    backgroundImage: "url(/assets/img/team/team-1.jpg)",
                  }}
                >
              ...
              <div className="col-lg-4">
                <div
                  className="ts-item set-bg"
                  style={{
                    backgroundImage: "url(/assets/img/team/team-2.jpg)",
                  }}
                >
                  <div className="ts_text">
                    <h4>Athart Rachel</h4>
              ...
              <div className="col-lg-4">
                <div
                  className="ts-item set-bg"
                  style={{
                    backgroundImage: "url(/assets/img/team/team-3.jpg)",
                  }}
                >
                  <div className="ts_text">
                    <h4>Athart Rachel</h4>
              ...
              <div className="col-lg-4">
                <div
                  className="ts-item set-bg"
                  style={{
                    backgroundImage: "url(/assets/img/team/team-4.jpg)",
                  }}
                >
                  <div className="ts_text">
                    <h4>Athart Rachel</h4>
              ...
              <div className="col-lg-4">
                <div
                  className="ts-item set-bg"
                  style={{
                    backgroundImage: "url(/assets/img/team/team-5.jpg)",
                  }}
                >
                  <div className="ts_text">
                    <h4>Athart Rachel</h4>
              ...
              <div className="col-lg-4">
                <div
                  className="ts-item set-bg"
                  style={{
                    backgroundImage: "url(/assets/img/team/team-6.jpg)",
                  }}
                >
                  <div className="ts_text">
                    <h4>Athart Rachel</h4>
